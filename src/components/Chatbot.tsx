  ...
  >
    <div className="bg-secondary p-2 sm:p-3 rounded-2xl max-w-[70%]">
      <motion.div
        ...
        className="flex items-center text-sm font-medium text-primary sm:text-base"
      >
        <svg className="w-4 h-4 mr-2 -ml-1 sm:w-5 sm:h-5 sm:mr-3 text-primary animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
